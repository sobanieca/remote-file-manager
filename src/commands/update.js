  ...
  if (denoFlag) {
    ...
    const command = new Deno.Command("deno", {
      args: [
        ...
        "--allow-write",
        "--allow-run",
        "--allow-env=TERM,CI,FORCE_COLOR,NO_COLOR",
        "-f",
        "-r",
        "-n",
        "rfm",
    ...
    console.log("");
    console.log(
      "  deno install -g --allow-net --allow-read --allow-write --allow-run --allow-env=TERM,CI,FORCE_COLOR,NO_COLOR -f -r -n rfm jsr:@sobanieca/remote-file-manager",
    );
    console.log("");
